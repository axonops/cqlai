...
type ConversationMessage struct {
	...
	// Reasoning is set on a message that is Claude's thinking rather than its
	// answer: the models think before they answer, and showing it is the
	// difference between a pause and something to read while it works.
	Reasoning bool
}
