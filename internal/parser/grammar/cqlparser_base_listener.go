...
func (s *BaseCqlParserListener) EnterDescribeCommand(ctx *DescribeCommandContext) {}

// ExitDescribeCommand is called when production describeCommand is exited.
func (s *BaseCqlParserListener) ExitDescribeCommand(ctx *DescribeCommandContext) {}

// EnterConsistencyCommand is called when production consistencyCommand is entered.
func (s *BaseCqlParserListener) EnterConsistencyCommand(ctx *ConsistencyCommandContext) {}

// ExitConsistencyCommand is called when production consistencyCommand is exited.
func (s *BaseCqlParserListener) ExitConsistencyCommand(ctx *ConsistencyCommandContext) {}
...
// EnterKwConnection is called when production kwConnection is entered.
func (s *BaseCqlParserListener) EnterKwConnection(ctx *KwConnectionContext) {}

// ExitKwConnection is called when production kwConnection is exited.
func (s *BaseCqlParserListener) ExitKwConnection(ctx *KwConnectionContext) {}

// EnterKwConsistency is called when production kwConsistency is entered.
func (s *BaseCqlParserListener) EnterKwConsistency(ctx *KwConsistencyContext) {}

// ExitKwConsistency is called when production kwConsistency is exited.
func (s *BaseCqlParserListener) ExitKwConsistency(ctx *KwConsistencyContext) {}

// EnterKwConsistencyLevel is called when production kwConsistencyLevel is entered.
func (s *BaseCqlParserListener) EnterKwConsistencyLevel(ctx *KwConsistencyLevelContext) {}

// ExitKwConsistencyLevel is called when production kwConsistencyLevel is exited.
func (s *BaseCqlParserListener) ExitKwConsistencyLevel(ctx *KwConsistencyLevelContext) {}
...
// EnterKwLocalSerial is called when production kwLocalSerial is entered.
func (s *BaseCqlParserListener) EnterKwLocalSerial(ctx *KwLocalSerialContext) {}

// ExitKwLocalSerial is called when production kwLocalSerial is exited.
func (s *BaseCqlParserListener) ExitKwLocalSerial(ctx *KwLocalSerialContext) {}
...
// EnterKwSerial is called when production kwSerial is entered.
func (s *BaseCqlParserListener) EnterKwSerial(ctx *KwSerialContext) {}

// ExitKwSerial is called when production kwSerial is exited.
func (s *BaseCqlParserListener) ExitKwSerial(ctx *KwSerialContext) {}
