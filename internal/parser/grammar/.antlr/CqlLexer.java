// Generated from /home/hayato/git/cqlai/internal/parser/grammar/CqlLexer.g4 by ANTLR 4.13.1
...
public class CqlLexer extends Lexer {
	...
	public static final int
		...
		K_SCHEMA=116, K_SELECT=117, K_SERIAL=118, K_SET=119, K_SFUNC=120, K_STATIC=121, 
		K_STORAGE=122, K_STYPE=123, K_SUPERUSER=124, K_TABLE=125, K_TABLES=126, 
		K_THREE=127, K_TIMESTAMP=128, K_TO=129, K_TOKEN=130, K_TRIGGER=131, K_TRUE=132, 
		K_TRUNCATE=133, K_TTL=134, K_TWO=135, K_TYPE=136, K_TYPES=137, K_UNLOGGED=138, 
		K_UPDATE=139, K_USE=140, K_USER=141, K_USING=142, K_UUID=143, K_VALUES=144, 
		K_VIEW=145, K_WHERE=146, K_WITH=147, K_WRITETIME=148, K_ASCII=149, K_BIGINT=150, 
		K_BLOB=151, K_BOOLEAN=152, K_COUNTER=153, K_DATE=154, K_DECIMAL=155, K_DOUBLE=156, 
		K_FLOAT=157, K_FROZEN=158, K_INET=159, K_INT=160, K_LIST=161, K_MAP=162, 
		K_SMALLINT=163, K_TEXT=164, K_TIMEUUID=165, K_TIME=166, K_TINYINT=167, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"K_SERIAL", "K_SET", "K_SFUNC", "K_STATIC", "K_STORAGE", "K_STYPE", "K_SUPERUSER", 
			"K_TABLE", "K_TABLES", "K_THREE", "K_TIMESTAMP", "K_TO", "K_TOKEN", "K_TRIGGER", 
			"K_TRUE", "K_TRUNCATE", "K_TTL", "K_TWO", "K_TYPE", "K_TYPES", "K_UNLOGGED", 
			...
			"K_FROZEN", "K_INET", "K_INT", "K_LIST", "K_MAP", "K_SMALLINT", "K_TEXT", 
			"K_TIMEUUID", "K_TIME", "K_TINYINT", "K_TUPLE", "K_VARCHAR", "K_VARINT", 
			"CODE_BLOCK", "STRING_LITERAL", "DECIMAL_LITERAL", "FLOAT_LITERAL", "HEXADECIMAL_LITERAL", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'SERIAL'", "'SET'", "'SFUNC'", "'STATIC'", "'STORAGE'", "'STYPE'", "'SUPERUSER'", 
			"'TABLE'", "'TABLES'", "'THREE'", "'TIMESTAMP'", "'TO'", "'TOKEN'", "'TRIGGER'", 
			"'TRUE'", "'TRUNCATE'", "'TTL'", "'TWO'", "'TYPE'", "'TYPES'", "'UNLOGGED'", 
