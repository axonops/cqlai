...
type CqlParserListener interface {
	...
	// EnterConsistencyCommand is called when entering the consistencyCommand production.
	EnterConsistencyCommand(c *ConsistencyCommandContext)
	...
	// EnterKwConnection is called when entering the kwConnection production.
	EnterKwConnection(c *KwConnectionContext)

	// EnterKwConsistency is called when entering the kwConsistency production.
	EnterKwConsistency(c *KwConsistencyContext)

	// EnterKwConsistencyLevel is called when entering the kwConsistencyLevel production.
	EnterKwConsistencyLevel(c *KwConsistencyLevelContext)
	...
	// EnterKwLocalSerial is called when entering the kwLocalSerial production.
	EnterKwLocalSerial(c *KwLocalSerialContext)
	...
	// EnterKwSerial is called when entering the kwSerial production.
	EnterKwSerial(c *KwSerialContext)
	...
	// ExitConsistencyCommand is called when exiting the consistencyCommand production.
	ExitConsistencyCommand(c *ConsistencyCommandContext)
	...
	// ExitKwConnection is called when exiting the kwConnection production.
	ExitKwConnection(c *KwConnectionContext)

	// ExitKwConsistency is called when exiting the kwConsistency production.
	ExitKwConsistency(c *KwConsistencyContext)

	// ExitKwConsistencyLevel is called when exiting the kwConsistencyLevel production.
	ExitKwConsistencyLevel(c *KwConsistencyLevelContext)
	...
	// ExitKwLocalSerial is called when exiting the kwLocalSerial production.
	ExitKwLocalSerial(c *KwLocalSerialContext)
	...
	// ExitKwSerial is called when exiting the kwSerial production.
	ExitKwSerial(c *KwSerialContext)
