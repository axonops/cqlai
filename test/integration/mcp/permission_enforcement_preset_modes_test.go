...
func TestPermissionLockdownEnforcement(t *testing.T) {
	...
	ctx := startMCPFromConfigHTTP(t, "testdata/dba_locked.json")
	defer stopMCPHTTP(ctx)
...
func TestConfirmationLifecycle(t *testing.T) {
	...
	t.Run("get_approved_empty", func(t *testing.T) {
		resp := callToolHTTP(t, ctx, "get_approved_confirmations", map[string]any{})
		if resp != nil {
	...
	t.Run("get_denied_empty", func(t *testing.T) {
		resp := callToolHTTP(t, ctx, "get_denied_confirmations", map[string]any{})
		if resp != nil {
	...
	t.Run("get_cancelled_empty", func(t *testing.T) {
		resp := callToolHTTP(t, ctx, "get_cancelled_confirmations", map[string]any{})
		if resp != nil {
